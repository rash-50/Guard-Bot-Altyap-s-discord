...
.setDescription(`<:krali:1160170285539008582>  ***Açılan Kanal Koruma Sistem Bilgilendirmesi***\n *Açılan kanalları anında kapatır ama açan kişiye müdahalede bulunmaz.*\n`)
.addField(`<:krali:1160170285539008582>  **Nasıl Açacağım?**`,"`r!açılan-kanal-koruma aç`\n")
.addField(`<:krali:1160170285539008582>  **Nasıl Kapatacağım?**`,"`r!açılan-kanal-koruma kapat`")
