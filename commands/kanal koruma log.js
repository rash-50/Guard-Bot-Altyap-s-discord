...
.setDescription(`<:krali:1160170285539008582>  ***Kanal-Log Sistem Bilgilendirmesi***\n *Kanal Koruma Sistemi loglarını belirlediğiniz kanala gönderir.*\n`)
.addField(`<:krali:1160170285539008582> **Nasıl Ayarlayacağım?**`,"`r!kanal-log #kanal`\n")
.addField(`<:krali:1160170285539008582>  **Nasıl Kapatacağım?**`,"`r!kanal-log kapat`")
